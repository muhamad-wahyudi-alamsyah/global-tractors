...
<body class="gti-body">
                                        ...
                                        <td class="col-actions">
                                            <div class="gti-ue-action-menu">
                                                ...
                                                <div class="gti-ue-action-dropdown">
                                                    ...
                                                    <button type="button" class="gti-ue-action-item delete" onclick="openDeleteModal(<?php echo esc_attr($quot->id); ?>, '<?php echo esc_js($quot->quotation_id); ?>', '<?php echo esc_js($quot->customer_name); ?>')">
        ...
        <div class="gti-ue-delete-modal">
            ...
            <div class="gti-ue-delete-body">
                <div class="gti-ue-delete-eq-info">
                    <div class="gti-ue-delete-eq-thumb" id="delete-eq-thumb"><i class="fas fa-clipboard-list"></i></div>
                    <div>
                ...
                <div class="gti-ue-delete-warning">
                    ...
                    <span>Quotation will be permanently removed from the system. This data cannot be recovered.</span>
                </div>
            </div>
    ...
    // ====== Delete Quotation — modal + toast ======
    var _deleteQuotId = null;

    function openDeleteModal(quotationId, quotationCode, customer) {
        _deleteQuotId = quotationId;
        document.getElementById('delete-eq-name').textContent = customer || '—';
        document.getElementById('delete-eq-code').textContent = quotationCode || '—';
    ...
    function handleDeleteConfirm() {
        if (!_deleteQuotId) return;
        var confirmBtn = document.getElementById('gti-delete-confirm-btn');
        confirmBtn.disabled = true;
        confirmBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Deleting...';

        var deletedId = _deleteQuotId;
        var formData = new FormData();
        formData.append('action', 'gti_delete_quotation');
        ...
        .then(function(res) {
            if (res.success) {
                closeDeleteModal();
                showUeToast(res.data?.message || 'Quotation deleted', 'success');
                var row = document.querySelector('tr[data-quot-id="' + deletedId + '"]');
                if (row) {
                ...
                confirmBtn.disabled = false;
                confirmBtn.innerHTML = '<i class="fas fa-trash"></i> Delete';
                showUeToast(res.data?.message || 'Failed to delete quotation', 'error');
            }
        })
        .catch(function() {
            confirmBtn.disabled = false;
