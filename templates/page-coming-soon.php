    ...
    <div class="gti-wrapper">
        ...
        <aside class="gti-sidebar" id="gti-sidebar">
            ...
            <nav class="gti-nav">
                ...
                <div class="gti-nav-group gti-has-children<?php echo $is_equipment_child ? ' open' : ''; ?>">
                    <div class="gti-nav-section">EQUIPMENT</div>
                    <a href="#" class="gti-nav-parent<?php echo $is_equipment_child ? ' active' : ''; ?>" data-toggle="dropdown"><i class="fas fa-truck"></i><span>Equipment</span><i class="fas fa-chevron-down gti-nav-arrow"></i></a>
                    <div class="gti-nav-children">
                        ...
                        <a href="<?php echo esc_url(gti_dashboard_url('rental-equipment')); ?>" class="gti-nav-child<?php echo $page_slug === 'rental-equipment' ? ' active' : ''; ?>"><i></i><span>Rental Equipment</span></a>
                    </div>
                    <a href="<?php echo esc_url(gti_dashboard_url('spare-parts')); ?>" class="gti-nav-item<?php echo $page_slug === 'spare-parts' ? ' active' : ''; ?>"><i class="fas fa-cog"></i><span>Spare Parts</span></a>
                </div>
                ...
                <div class="gti-nav-group">
                    ...
                    <a href="<?php echo esc_url(gti_dashboard_url('customers')); ?>" class="gti-nav-item<?php echo $page_slug === 'customers' ? ' active' : ''; ?>"><i class="fas fa-users"></i><span>Customers</span></a>
                    <a href="<?php echo esc_url(gti_dashboard_url('news-articles')); ?>" class="gti-nav-item<?php echo $page_slug === 'news-articles' ? ' active' : ''; ?>"><i class="fas fa-newspaper"></i><span>News &amp; Articles</span></a>
                    <a href="<?php echo esc_url(gti_dashboard_url('media-library')); ?>" class="gti-nav-item<?php echo $page_slug === 'media-library' ? ' active' : ''; ?>"><i class="fas fa-photo-video"></i><span>Media Library</span></a>
                </div>
