...
// Filter options
$categories = gti_distinct_values( 'equipment', 'category', array( 'type' => 'used' ) );
$brands = gti_distinct_values( 'equipment', 'brand', array( 'type' => 'used' ) );
                ...
                <div class="gti-ue-stats-row">
                    ...
                    <div class="gti-ue-stat-card">
                        ...
                        <div class="gti-ue-stat-info">
                            ...
                            <p class="gti-ue-stat-value"><?php echo esc_html(gti_format_number($status_count_map['sold'] ?? 0)); ?></p>
                        </div>
                    </div>
                    <div class="gti-ue-stat-card">
                            ...
                            <?php else: ?>
                                <?php foreach ($equipments as $eq): ?>
                                    <tr data-eq-id="<?php echo esc_attr($eq->id); ?>" data-eq='<?php echo esc_attr(json_encode($eq)); ?>'>
                                        ...
                                        <td class="col-price" title="<?php echo esc_attr($_gti_eq_fmt($eq->price)); ?>"><?php echo esc_html($_gti_eq_fmt($eq->price)); ?></td>
