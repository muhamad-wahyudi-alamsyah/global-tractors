<?php
/**
 * Template: Add New Rental Equipment (/dashboard/rental-equipment/add)
...
<head>
    ...
    <title>Add New Rental Equipment - <?php bloginfo('name'); ?></title>
        ...
        <main class="gti-main" id="gti-main">
            ...
            <header class="gti-header">
                <div class="gti-header-left">
                    ...
                    <div>
                        <h1 class="gti-page-title">Add New Rental Equipment</h1>
                ...
                <form class="gti-ae-form" id="gti-ae-form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="gti-ae-form-grid">
                                    <div class="gti-ae-field">
                                        ...
                                        <select name="type">
                                            ...
                                            <option value="rental" selected>Rental Equipment</option>
                                        </select>
                                    </div>
                                    <div class="gti-ae-field">
                    ...
                    <div class="gti-ae-form-nav">
                        ...
                        <div class="gti-ae-form-nav-right">
                            <a href="<?php echo esc_url(gti_dashboard_url('rental-equipment')); ?>" class="gti-ae-btn gti-ae-btn-cancel">Cancel</a>
                            ...
                            <button type="button" class="gti-ae-btn gti-ae-btn-submit" id="gti-ae-submit" style="display:none;">
                                <i class="fas fa-check"></i> Add Rental Equipment
                            </button>
                        </div>
                    </div>
                </form>
